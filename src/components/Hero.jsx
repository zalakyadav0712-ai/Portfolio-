    ...
    <section id="hero" className={styles.hero}>
      <div className={styles.content}>
        ...
        <p className={styles.summary}>
          Full Stack Developer with <span className="accent">3.5+ years</span> of experience building
          enterprise-grade web applications using <span className="accent">React.js</span> and{' '}
          <span className="accent">.NET Core</span>. Specializing in Microsoft 365 &amp; Teams App
          development for international clients across the{' '}
          <span className="accent">US and UK</span>.
        </p>
        ...
        <div className={styles.actions}>
          ...
          <a
            href="mailto:zalakyadav0712@gmail.com"
